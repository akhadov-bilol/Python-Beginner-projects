# encoding: utf-8
# module select
# from C:\Users\ielts\AppData\Local\Programs\Python\Python39\DLLs\select.pyd
# by generator 1.147
"""
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001EEEFBBEFA0>'

__spec__ = None # (!) real value is "ModuleSpec(name='select', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001EEEFBBEFA0>, origin='C:\\\\Users\\\\ielts\\\\AppData\\\\Local\\\\Programs\\\\Python\\\\Python39\\\\DLLs\\\\select.pyd')"
